...
/**
 * BubbleSort is front loaded and performs the sort on construction.
 * 
 * Additional processing is used to pull data about the Sort itself.
 * 
 * @author UnfortunateCode
 */
public class BubbleSort<T extends Comparable<T>> extends SortStructure<T>{
	 ...
	 */
	public BubbleSort (T[] randomizedArray) {
